...
//    String modelName = "models/black_smith/black_smith.obj";
  String modelName = "models/windmill/windmill.obj";
    ...
    if (model != nullptr) {
        ...
        if (mesh != nullptr) {
          ...
          // load Texture
          //   String texAlbedo = "models/Avatar/body.png";
          //   String texNormal = "models/Avatar/body2.png";
          //   String texPbr = "models/Avatar/Pbr_01.png";
          //   String texEmissive = "shaders/pbr_brdf.png";
          //   String texEmissive = "models/Avatar/pbr_brdf.png";
          // added texture for black smith
  //        String texAlbedo = "models/black_smith/texture/blksmith.png";
          // windmill texture files

            String texAlbedo = "models/windmill/textures/windmill_base.png"; //Statuette_sheep_diffuse.png";
            String texNormal = "models/windmill/textures/windmill_lopatky.png";
            String texPbr = "models/sheep/textures/Statuette_sheep_glossiness.png";
            String texEmissive = "models/sheep/textures/Statuette_sheep_specular.png";
            ...
            for (u32 i = 0; i < subMeshCnt; ++i) {
                ...
                // use these textures for windmill
                /*
...
//    String modelName = "cubemaps/env/cube.obj";
    Model* model = dynamic_cast<Model*>(gResourceManager.Get(modelName));
    const Mesh* mesh = model->GetMesh();
    // load Texture
    u32 subMeshCnt = mesh->GetSubMeshCount();
